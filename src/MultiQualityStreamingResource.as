package {
	...
	public class MultiQualityStreamingResource extends StreamingURLResource implements IEventDispatcher {
		...
		static public const RECORDED_DATA_REQUEST:String = "http://new.tvbreak.ru/api/movies/|SRCID|/source.json";
		static public const LIVE_DATA_REQUEST:String = "http://new.tvbreak.ru/api/tv/|SRCID|/source.json";
