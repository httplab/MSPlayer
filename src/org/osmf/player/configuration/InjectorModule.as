	...
	public class InjectorModule {
		...
		*/ 
		...
		private function provideResource():MediaResourceBase {
			...
			} else if (configuration.type && configuration.srcId) {
				resource = new MultiQualityStreamingResource(configuration.srcId, configuration.type);
			} else {
		...
		private function provideConfigurationProxy():ConfigurationProxy {
			...
			configurationProxy.registerConfigurableProperties(resourceFields, getInstance(PlayerConfiguration).resource);
